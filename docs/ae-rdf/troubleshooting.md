...
- A successful **Test** in the [Endpoint Manager](endpoints.md#test-before-saving) (or a populated Types sidebar) means CORS is fine.
...
- **Authentication** — a protected endpoint needs credentials set on the endpoint ([Authentication](endpoints.md#authentication)).
- **Graph config mismatch** — if the endpoint's [graph config](graphs.md#how-it-works)
