...
Active [facet](03-facets.md) selections are kept in the URL too (`?filters=…`), so a **filtered** list is shareable and steps through back/forward like everything else.
