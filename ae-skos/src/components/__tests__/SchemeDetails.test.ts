  ...
  describe('with scheme loaded', () => {
    beforeEach(() => {
      ...
      mockDetails.value = {
        ...
        examples: [],
        comments: [],
        dctTitles: [{ value: 'DC Title', lang: 'en' }],
        dcTitles: [],
        description: [{ value: 'DC Description', lang: 'en' }],
        creator: ['http://example.org/person/1'],
        created: { value: '2024-01-01', datatype: 'http://www.w3.org/2001/XMLSchema#date' },
        modified: { value: '2024-06-15', datatype: 'http://www.w3.org/2001/XMLSchema#dateTime' },
        issued: { value: '2024-01-01', datatype: undefined },
        publisher: [],
        rights: [],
        license: [],
        ccLicense: [],
